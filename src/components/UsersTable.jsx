    ...
    <div className="glass rounded-2xl p-5 animate-fade-up delay-3">
      ...
      <div className="relative mb-4">
        ...
        <input
          ...
          className="w-full text-[12px] pl-8 pr-3 py-2 rounded-xl bg-white/50 border border-white/60 focus:outline-none focus:ring-1 focus:ring-indigo-300 placeholder:text-gray-300"
        />
      </div>
